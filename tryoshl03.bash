...
do
	...
	do
		showUname $fmt $dss >$TD/tryoshl03_${fmt}_${dss}.html
		for color in gainsboro chartreuse hotpink peru green NONE
		do
			showUname $fmt $dss $color >$TD/tryoshl03_${fmt}_${dss}_${color}.html
			for fs in 7pt 8pt 9pt 10pt 11pt 12pt
			do
				showUname $fmt $dss $color $fs >$TD/tryoshl03_${fmt}_${dss}_${color}_$fs.html
